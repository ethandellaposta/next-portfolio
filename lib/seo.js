  ...
  return {
    ...
    '@graph': [
      ...
      },
      {
        ...
        worksFor: { '@type': 'Organization', name: 'SRC', url: 'https://www.srcinc.com' },
        alumniOf: [
        ...
        knowsAbout: [
          ...
          'C++', 'Radar Signal Processing', 'Real-Time Systems', 'GraphQL',
          'MySQL', 'AWS', 'Docker', 'Kubernetes', 'Go', 'Linux',
          'gRPC', 'Protobuf', 'WebGL', 'Feathers.js'
        ],
        sameAs: [
        ...
        email: 'mailto:ethandellaposta@gmail.com',
        description: SITE_DESCRIPTION
      },
      {
          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                ...
                description: 'End-to-end web application development with React, Next.js, Node.js'
              }
            },
            {
              '@type': 'Offer',
              itemOffered: {
                ...
                description: 'Signal processing pipelines, real-time data acquisition, C++ systems'
              }
            }
          ]
        }
        ...
        itemListElement: [
          {
            ...
            item: {
              ...
              description: 'Real-time single and multicellular life evolution simulator'
            }
          },
          {
            '@type': 'ListItem',
            ...
            item: {
              ...
              applicationCategory: 'Simulation',
              description: 'Real-time model of our solar system with accurate orbital mechanics'
            }
          }
        ]
      }
